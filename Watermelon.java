...
public class Watermelon extends Actor
{
    ...
    private int numChopsReq = 4; // chops it takes to become diced;
    ...
    public Watermelon(PlateBack plate, CuttingBoard cuttingBoard, CuttingKnife cuttingKnife, BuildingWorld buildTab) {
        this.plate = plate;
