...
public class Pumpkin extends Actor
{
    ...
    private int numChopsReq = 6; // chops it takes to become diced;
    ...
    public Pumpkin(PlateBack plate, CuttingBoard cuttingBoard, CuttingKnife cuttingKnife, BuildingWorld buildTab) {
        this.plate = plate;
